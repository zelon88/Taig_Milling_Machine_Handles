...
// NAME:  Handle - Modular Endcap
// PART ID:  TMMH-004
// REVISION:  A1
// START DATE:  2/28/2022
// CURRENT VERSION DATE:  2/28/2022
// AUTHOR:  Justin Grimes (@zelon88)
// DESCRIPTION:   The Modular Endcap serves to spread the load of the modular handles to the support 
//    gussets built into the handle wheel. They also act as a friction surface between the modular 
//    handles &  modular washers. This file defines a module named "modularEndcap()" which can be called 
//    with no arguments to render the endcap. This file is included in "TMMH-005.scad" which is an 
//    assembled model of the project, and in "TMMH-006.scad" which has all components arranged for 
//    3D Printing.
// FILE NAME: TMMH-004.scad
// ----------------------------------------------------------------------------------------------------
